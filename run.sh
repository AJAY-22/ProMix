...
python Train_promix.py --cosine --dataset cifar100 --num_class 100 --rho_range 0.5,0.5 --tau 0.95 --pretrain_ep 30 --debias_output 0.5 --debias_pl 0.5  --noise_mode asym --noise_rate 0.5
# For CIFAR-10N 
# #aggre
